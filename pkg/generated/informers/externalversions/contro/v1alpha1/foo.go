...
import (
	...
	controv1alpha1 "k8s.io/contro/pkg/apis/contro/v1alpha1"
	versioned "k8s.io/contro/pkg/generated/clientset/versioned"
	internalinterfaces "k8s.io/contro/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "k8s.io/contro/pkg/generated/listers/contro/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ControV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ControV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&controv1alpha1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&controv1alpha1.Foo{}, f.defaultInformer)
}
