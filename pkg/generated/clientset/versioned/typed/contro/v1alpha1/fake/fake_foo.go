...
type FakeFoos struct {
	Fake *FakeControV1alpha1
	ns   string
}

var foosResource = schema.GroupVersionResource{Group: "contro.k8s.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "contro.k8s.io", Version: "v1alpha1", Kind: "Foo"}
